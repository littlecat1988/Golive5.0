...
public class StaggeredGridLayoutManager extends GridLayoutManager {
    ...
    public StaggeredGridLayoutManager(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle, 2, 2);
    }
    ...
    public static class LayoutParams extends TvRecyclerView.LayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            ...
            TypedArray a = c.obtainStyledAttributes(attrs,
                    R.styleable.TvRecyclerView_StaggeredGridViewChild);
            span = Math.max(DEFAULT_SPAN,
                    a.getInt(R.styleable.TvRecyclerView_StaggeredGridViewChild_tv_span, -1));
            a.recycle();
        }
