...
package com.golive.cinema.views.metroviews;
...
//            Log.i(LOGTAG, "onLayoutChildren: anchorItemPosition="+anchorItemPosition + " ,
// offset="+getPendingScrollOffset());
    ...
    protected abstract void moveLayoutToPosition(int position, int offset, Recycler recycler,
            State state);
