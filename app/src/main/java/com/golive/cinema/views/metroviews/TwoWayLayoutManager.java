...
//        Log.i(LOGTAG, "scrollBy..2..delta = "+delta + " ,mLayoutStart = "+mLayoutStart + " ,
// mLayoutEnd = "+mLayoutEnd);
...
//        Log.i(LOGTAG, "scrollBy..3..delta = "+delta + " ,mLayoutStart = "+mLayoutStart + " ,
// mLayoutEnd = "+mLayoutEnd);
        return delta;
    }
...
//        Log.i(LOGTAG, "fillGap...childCount="+childCount+" ,extraSpace="+extraSpace+" ,
