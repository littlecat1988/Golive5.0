...
public class ReportEnterAdUseCase extends
        UseCase<ReportEnterAdUseCase.RequestValues,
                ReportEnterAdUseCase
                        .ResponseValue> {
    private final StatisticsDataSource mStatisticsDataSource;

    public ReportEnterAdUseCase(
    ...
    protected Observable<ResponseValue> executeUseCase(final RequestValues requestValues) {
        return mStatisticsDataSource.reportEnterAd(requestValues.caller)
    ...
    public static final class RequestValues implements UseCase.RequestValues {
        ...
        public RequestValues(String caller) {
            this.caller = caller;
        }
    }
