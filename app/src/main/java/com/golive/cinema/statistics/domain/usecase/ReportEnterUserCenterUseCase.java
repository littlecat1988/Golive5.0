...
public class ReportEnterUserCenterUseCase extends
        UseCase<ReportEnterUserCenterUseCase.RequestValues,
                ReportEnterUserCenterUseCase
                        .ResponseValue> {
    private final StatisticsDataSource mStatisticsDataSource;

    public ReportEnterUserCenterUseCase(@NonNull BaseSchedulerProvider schedulerProvider,
    ...
    protected Observable<ResponseValue> executeUseCase(final RequestValues requestValues) {
        return mStatisticsDataSource.reportEnterUserCenter()
