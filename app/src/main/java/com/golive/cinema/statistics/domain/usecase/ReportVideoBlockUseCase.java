...
public class ReportVideoBlockUseCase extends
        UseCase<ReportVideoBlockUseCase.RequestValues, ReportVideoBlockUseCase
                .ResponseValue> {
    private final StatisticsDataSource mStatisticsDataSource;

    public ReportVideoBlockUseCase(@NonNull BaseSchedulerProvider schedulerProvider,
    ...
    protected Observable<ResponseValue> executeUseCase(final RequestValues requestValues) {
        return mStatisticsDataSource.reportVideoBlocked(requestValues.filmId,
                requestValues.filmName, requestValues.filmType, requestValues.watchType,
                requestValues.definition, requestValues.mediaIp, requestValues.bufferDuration,
