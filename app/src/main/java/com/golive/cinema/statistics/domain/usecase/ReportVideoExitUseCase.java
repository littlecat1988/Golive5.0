...
public class ReportVideoExitUseCase extends
        UseCase<ReportVideoExitUseCase.RequestValues,
                ReportVideoExitUseCase
                        .ResponseValue> {
    private final StatisticsDataSource mStatisticsDataSource;

    public ReportVideoExitUseCase(@NonNull BaseSchedulerProvider schedulerProvider,
    ...
    protected Observable<ResponseValue> executeUseCase(final RequestValues requestValues) {
        return mStatisticsDataSource.reportVideoExit(requestValues.filmId, requestValues.filmName,
    ...
    public static final class RequestValues implements UseCase.RequestValues {
        ...
        public RequestValues(String filmId, String filmName, String filmType, String watchType,
                String definition, String watchDuration, String playDuration,
