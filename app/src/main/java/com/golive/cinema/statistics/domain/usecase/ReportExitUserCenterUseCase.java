...
public class ReportExitUserCenterUseCase extends
        UseCase<ReportExitUserCenterUseCase.RequestValues,
                ReportExitUserCenterUseCase
                        .ResponseValue> {
    private final StatisticsDataSource mStatisticsDataSource;

    public ReportExitUserCenterUseCase(@NonNull BaseSchedulerProvider schedulerProvider,
    ...
    protected Observable<ResponseValue> executeUseCase(final RequestValues requestValues) {
        return mStatisticsDataSource.reportExitUserCenter(requestValues.duration)
