...
public class ReportThirdPartyAdUseCase extends
        UseCase<ReportThirdPartyAdUseCase.RequestValues, ReportThirdPartyAdUseCase.ResponseValue> {
    private final StatisticsDataSource mStatisticsDataSource;

    public ReportThirdPartyAdUseCase(@NonNull BaseSchedulerProvider schedulerProvider,
    ...
    protected Observable<ResponseValue> executeUseCase(final RequestValues requestValues) {
        return mStatisticsDataSource.reportThirdPartyAd(requestValues.mReportUrl)
