...
public class ReportAppExitUseCase extends
        UseCase<ReportAppExitUseCase.RequestValues, ReportAppExitUseCase
                .ResponseValue> {
    private final StatisticsDataSource mStatisticsDataSource;

    public ReportAppExitUseCase(@NonNull BaseSchedulerProvider schedulerProvider,
    ...
    protected Observable<ResponseValue> executeUseCase(final RequestValues requestValues) {
        return mStatisticsDataSource.reportAppExit(requestValues.mDuration)
    ...
    public static final class RequestValues implements UseCase.RequestValues {
        ...
        public RequestValues(String duration) {
            mDuration = duration;
        }
    }
