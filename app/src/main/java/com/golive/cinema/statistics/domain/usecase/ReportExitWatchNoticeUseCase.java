...
public class ReportExitWatchNoticeUseCase extends
        UseCase<ReportExitWatchNoticeUseCase.RequestValues,
                ReportExitWatchNoticeUseCase
                        .ResponseValue> {
    private final StatisticsDataSource mStatisticsDataSource;

    public ReportExitWatchNoticeUseCase(
    ...
    protected Observable<ResponseValue> executeUseCase(final RequestValues requestValues) {
        return mStatisticsDataSource.reportExitWatchNotice(requestValues.button,
