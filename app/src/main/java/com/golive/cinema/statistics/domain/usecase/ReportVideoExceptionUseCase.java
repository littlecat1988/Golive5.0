...
public class ReportVideoExceptionUseCase extends
        UseCase<ReportVideoExceptionUseCase.RequestValues,
                ReportVideoExceptionUseCase
                        .ResponseValue> {
    private final StatisticsDataSource mStatisticsDataSource;

    public ReportVideoExceptionUseCase(@NonNull BaseSchedulerProvider schedulerProvider,
    ...
    protected Observable<ResponseValue> executeUseCase(final RequestValues requestValues) {
        return mStatisticsDataSource.reportVideoException(requestValues.filmId,
                requestValues.filmName, requestValues.filmType, requestValues.watchType,
                requestValues.definition, requestValues.errCode, requestValues.errMsg,
                requestValues.watchDuration, requestValues.playDuration,
                requestValues.totalDuration, requestValues.playProgress, requestValues.orderSerial,
                requestValues.valueType)
    ...
    public static final class RequestValues implements UseCase.RequestValues {
        ...
        public RequestValues(String filmId, String filmName, String filmType, String watchType,
                String definition, String errMsg, String errCode, String watchDuration,
