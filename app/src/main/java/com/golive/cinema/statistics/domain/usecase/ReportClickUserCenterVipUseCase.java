...
public class ReportClickUserCenterVipUseCase extends
        UseCase<ReportClickUserCenterVipUseCase.RequestValues,
                ReportClickUserCenterVipUseCase
                        .ResponseValue> {
    private final StatisticsDataSource mStatisticsDataSource;

    public ReportClickUserCenterVipUseCase(
    ...
    protected Observable<ResponseValue> executeUseCase(final RequestValues requestValues) {
        return mStatisticsDataSource.reportClickUserCenterVip(requestValues.price,
