...
public class PolicyCompat {
    ...
    private static final String POLICY_MANAGER_CLASS_NAME =
    ...
    private static Window createPhoneWindow(Context context) {
        try {
            ...
            throw new RuntimeException(PHONE_WINDOW_CLASS_NAME + " class could not be instantiated",
                    e);
        }
    }
    ...
    private static Window makeNewWindow(Context context) {
        try {
            ...
            throw new RuntimeException(
                    POLICY_MANAGER_CLASS_NAME + ".makeNewWindow could not be invoked", e);
        }
    }
