...
public class GetUserWalletUseCase extends
        UseCase<GetUserWalletUseCase.RequestValues, GetUserWalletUseCase.ResponseValue> {

    private final UserDataSource mUserDataSource;

    public GetUserWalletUseCase(@NonNull UserDataSource dataSource,
    ...
    protected Observable<ResponseValue> executeUseCase(RequestValues requestValues) {
        if (requestValues.isForceUpdate()) {
            mUserDataSource.refreshWallet();
        }

        return mUserDataSource.getWallet()
