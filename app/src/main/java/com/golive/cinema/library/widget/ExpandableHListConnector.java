...
class ExpandableHListConnector extends BaseAdapter implements Filterable {
    ...
    PositionMetadata getUnflattenedPos(final int flPos) {
        ...
        if (numExpGroups == 0) {
             ...
             * same as its flPos
             */
            return PositionMetadata.obtain(flPos, ExpandableHListPosition.GROUP, flPos, -1, null,
                    0);
        }
        ...
        while (leftExpGroupIndex <= rightExpGroupIndex) {
            ...
            if (flPos > midExpGm.lastChildFlPos) {
                 ...
                 */
                return PositionMetadata.obtain(flPos, ExpandableHListPosition.GROUP, midExpGm.gPos,
                ...
                return PositionMetadata.obtain(flPos, ExpandableHListPosition.CHILD, midExpGm.gPos,
        ...
        return PositionMetadata.obtain(flPos, ExpandableHListPosition.GROUP, groupPos, -1, null,
                insertPosition);
    }
     ...
     * {@link ExpandableHListConnector.PositionMetadata}
    ...
    PositionMetadata getFlattenedPos(final ExpandableHListPosition pos) {
        ...
        if (numExpGroups == 0) {
             ...
             */
            return PositionMetadata.obtain(pos.groupPos, pos.type, pos.groupPos, pos.childPos, null,
                    0);
        }
        ...
        while (leftExpGroupIndex <= rightExpGroupIndex) {
            ...
            if (pos.groupPos > midExpGm.gPos) {
                ...
                if (pos.type == ExpandableHListPosition.GROUP) {
                    ...
                    return PositionMetadata.obtain(midExpGm.flPos, pos.type, pos.groupPos,
                    ...
                    return PositionMetadata.obtain(midExpGm.flPos + pos.childPos + 1, pos.type,
        ...
        if (leftExpGroupIndex > midExpGroupIndex) {
            ...
            return PositionMetadata.obtain(flPos, pos.type, pos.groupPos, pos.childPos, null,
                    leftExpGroupIndex);
        } else if (rightExpGroupIndex < midExpGroupIndex) {
     ...
     *                                  based on the group IDs. This should only be needed when
     *                                  calling
    ...
    static class GroupMetadata implements Parcelable, Comparable<GroupMetadata> {
        ...
        public static final Creator<GroupMetadata> CREATOR = new Creator<GroupMetadata>() {
            ...
            public GroupMetadata createFromParcel(Parcel in) {
                GroupMetadata gm = GroupMetadata.obtain(in.readInt(), in.readInt(), in.readInt(),
                        in.readLong());
                return gm;
            }
    ...
    static public class PositionMetadata {
        ...
        static PositionMetadata obtain(
                int flatListPos, int type, int groupPos, int childPos, GroupMetadata groupMetadata,
