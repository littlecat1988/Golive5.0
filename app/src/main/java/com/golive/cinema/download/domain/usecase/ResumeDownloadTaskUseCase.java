...
public class ResumeDownloadTaskUseCase extends
        UseCase<ResumeDownloadTaskUseCase.RequestValues, ResumeDownloadTaskUseCase
                .ResponseValue> {

    private final DownloadDataSource mDownloadDataSource;

    public ResumeDownloadTaskUseCase(
    ...
    protected Observable<ResponseValue> executeUseCase(RequestValues requestValues) {
        return mDownloadDataSource.resumeDownloadTask(requestValues.getFilmId(),
