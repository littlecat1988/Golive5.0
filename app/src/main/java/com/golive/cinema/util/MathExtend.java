...
public class MathExtend {
    ...
    /**
     * 提供（相对）精确的除法运算，当发生除不尽的情况时，精确到 小数点以后10位，以后的数字四舍五入,舍入模式采用HALF_EVEN
     *
     * @return 两个参数的商
     */
    ...
    /**
     * 提供（相对）精确的除法运算。当发生除不尽的情况时，由scale参数指 定精度，以后的数字四舍五入。舍入模式采用HALF_EVEN
     *
    ...
    /**
     * 提供精确的小数位四舍五入处理,舍入模式采用HALF_EVEN
     *
     * @param v     需要四舍五入的数字
